Die beiden Dateien "Dockerfile" und "requirements.txt" dienen dazu, eine Python-Webanwendung auf Basis von FastAPI in einer Docker-Umgebung aufzusetzen und auszuführen.
